...
&emsp;属性值最低只能被降至0。体质和感悟之外的属性值被降至0时，角色会陷入<昏迷>。体质值被降至0时，角色会立即<解体>。智慧值被降至0后，角色的[认知级别]会变为「无认知」。
...
- **劣等**  
	...
	如果角色的智慧属性为劣等阶层，她的[认知级别]会变为「低认知」。<HR>
- **次等**  
	数值为3~6的属性处于这个阶层。使用劣等属性进行技能检定时，总是会受到2点减值。<HR>
- **标准**
	数值为7~14的属性处于这个阶层。如果角色的智慧属性为标准或更高阶层，她的[认知级别]会变为「高认知」。<HR>
- **高等**
...
｜<FONT face=Wingdings>v</FONT> 角色尝试攀爬陡坡或滑坡或者在攀爬的同时回避危害物，又或者在有东西想撞开她的情况下抓紧壁面。  
｜<FONT face=Wingdings>v</FONT> 角色尝试跳跃非常远的距离，或在跳跃中杂耍。  
｜<FONT face=Wingdings>v</FONT> 角色尝试在凶险的水流，风暴浪涛或水草海域中挣扎游泳或浮出水面。或者其他生物试图将她推下水，或拉入水中，又或者以其他方式阻碍她游泳。  
｜<FONT face=Wingdings>v</FONT> 角色尝试强行突破卡死、上锁或栓住、堵塞的门，推倒一座雕像，止住滚动中的大圆石。

> ▼ **灵巧**  
｜*灵巧技能可以对应进行机敏、迅速、安静的移动，或在不稳定的地方保持平衡。*  
｜<FONT face=Wingdings>v</FONT> 角色尝试在冰块上奔跑，在绳索上平衡，在摇曳甲板上站稳等需要保持平衡的情况。  
｜<FONT face=Wingdings>v</FONT> 角色尝试躲起避过敌人，躲过守卫，偷偷溜走，无声息地绕到某人背后。  
｜<FONT face=Wingdings>v</FONT> 角色尝试在落坡时控制住重载的载具，控制车辆急转弯或避开障碍。  
｜<FONT face=Wingdings>v</FONT> 角色尝试牢牢地绑住战俘，或挣脱束缚物。 

> ▼ **耐力**  
*耐力技能可以对应忍受来自肉体的痛苦的能力。*  
｜<FONT face=Wingdings>v</FONT> 角色尝试闭气，不吃不喝，不眠不休。  
｜<FONT face=Wingdings>v</FONT> 角色尝试持续数小时不间断的行进工作。  
｜<FONT face=Wingdings>v</FONT> 角色尝试一口气吃下大量的食物。  
｜<FONT face=Wingdings>v</FONT> 角色尝试抵抗审讯。

#### 心智技能

> ▼ **学识**  
*学识技能可以对应需要记忆、经验、教育的状态。*  
｜<FONT face=Wingdings>v</FONT> 角色尝试回忆关于一门手艺或行业的知识。  
｜<FONT face=Wingdings>v</FONT> 角色尝试从伤口的外观判断它由什么武器造成。  
｜<FONT face=Wingdings>v</FONT> 角色尝试给一件贵重品估价。  
｜<FONT face=Wingdings>v</FONT> 角色尝试追踪，狩猎，区分有毒物质，辨认野兽的踪迹，预测天气，穿过冰原，回避流沙。

> ▼ **洞悉**  
*洞悉技能可以对应需要冷静、计算、分析的状态。*  
｜<FONT face=Wingdings>v</FONT> 角色尝试推断隐藏物件的位置，在一堆古书中寻找一段她所需要的知识。  
｜<FONT face=Wingdings>v</FONT> 角色尝试找出一台机器或一条隧道的结构性弱点。  
｜<FONT face=Wingdings>v</FONT> 角色尝试看清被遮蔽或容易看走眼的东西。  
｜<FONT face=Wingdings>v</FONT> 角色尝试演奏乐器，制作细致的小东西，对伤口进行应急处理。

> ▼ **直觉**  
*直觉技能可以对应对情境做出迅速的判断、抉择和反应，以及直觉性地感知事物变化的能力。*  
｜<FONT face=Wingdings>v</FONT> 角色尝试预感陷阱的存在，察觉周围环境的微妙变化。  
｜<FONT face=Wingdings>v</FONT> 角色尝试在困境中抓住关键的一丝线索。  
｜<FONT face=Wingdings>v</FONT> 角色尝试不使用言语与他人沟通。  
｜<FONT face=Wingdings>v</FONT> 角色尝试通过言行中的微妙细节，感知他人的情绪。

#### 社交技能

> ▼ **示威**  
*示威技能可以对应表达立场或要求，使他人同意自己想法，以及领导能力。*  
｜<FONT face=Wingdings>v</FONT> 角色尝试用威胁、敌对行为、暴力等使他人改变心意。  
｜<FONT face=Wingdings>v</FONT> 角色尝试通过言语或行动激励他人。  
｜<FONT face=Wingdings>v</FONT> 角色尝试发号施令，引导群众。  
｜<FONT face=Wingdings>v</FONT> 角色尝试维护自己的自尊和威严。

> ▼ **话术**  
*话术技能可以对应说服、欺骗、讲解、辩驳等沟通技巧。*  
｜<FONT face=Wingdings>v</FONT> 角色尝试以圆滑、优雅、善意的说辞影响他人的决定，改变对方的观点。  
｜<FONT face=Wingdings>v</FONT> 角色尝试在谈判中灵活运用语言技巧，赢得更多的好处。  
｜<FONT face=Wingdings>v</FONT> 角色尝试通过语言煽动他人的情绪。  
｜<FONT face=Wingdings>v</FONT> 角色尝试以言语或动作隐暪真相。

> ▼ **共情**  
*共情技能可以对应理解、感受并与他人建立情感联系，表现出对他人感受和处境的关怀和体恤。*  
｜<FONT face=Wingdings>v</FONT> 角色尝试辨别他人的真实意图，例如辨别谎言或预测其下一步行动。  
｜<FONT face=Wingdings>v</FONT> 角色尝试取悦他人，赢得好感。  
｜<FONT face=Wingdings>v</FONT> 角色尝试安抚他人的心灵。  
｜<FONT face=Wingdings>v</FONT> 角色尝试通过表演娱乐观众。
...
#### 造成伤势
&emsp;伤害造成的基础伤势级别由其效果决定。造成的伤势数量，则等于`DP-DR (最低0)`。直接造成伤势的效果则会无视DR。
...
### 伤害类型与损伤
&emsp;所有类型的伤害共可以分为「物理伤害」与「精神伤害」两类。只有物理伤害会造成伤势，精神伤害只会扣除受到伤害的角色的SP。

> ▼ **物理伤害**  
｜<FONT face=Wingdings>v</FONT> 冲击：由物体运动产生的力量冲击目标，如撞击、震荡等。  
｜<FONT face=Wingdings>v</FONT> 切割：利用锋利的物体分割目标，如割伤、裂伤等。  
｜<FONT face=Wingdings>v</FONT> 穿刺：通过物体尖端或锐利边缘直接刺入目标，如刺伤、穿刺伤等。  
｜<FONT face=Wingdings>v</FONT> 毒素：因有毒物质进入体内引起的生理机能异常，如毒药、瘴气所致的伤害。  
｜<FONT face=Wingdings>v</FONT> 失血：由于开放性伤口或其他原因导致的血液损失，如内出血、因外伤导致血流不止。  
｜<FONT face=Wingdings>v</FONT> 灼烧：通过高温或化学物质造成的烧伤，如火焰、闪电、酸性物质所致的伤害。  
｜<FONT face=Wingdings>v</FONT> 冷冻：通过极低温度引起的冰冻伤害，如低温环境、液氮所致的伤害。  
｜<FONT face=Wingdings>v</FONT> 腐蚀：化学物质侵蚀目标物体导致的伤害，如氧化、腐蚀性液体、核辐射所致的伤害。

> ▼ **精神伤害**  
｜<FONT face=Wingdings>v</FONT> 困顿：长时间持续使用肌肉或精神的过度疲劳，如长时间奔跑、超负荷工作。  
｜<FONT face=Wingdings>v</FONT> 疼痛：生理和心理上的疼痛感觉，如刺痛、灼痛等。  
｜<FONT face=Wingdings>v</FONT> 欣快：由积极、愉悦和兴奋的情绪对判断能力产生的影响，如性冲动、致幻药物等。  
｜<FONT face=Wingdings>v</FONT> 屈服：由心理上的压力、负面情绪、不安和无助感导致的心理退行，如强迫行为、压迫感、恐惧等。  
...
> ▼ **Mov**  
｜角色每回合能够移动的格数被称为「Mov」。Mov在冲突模式开始时为0点，当角色开始回合时，她的Mov会变为`速度`点。她可以使用具有［移动］标签的动作消耗Mov进行移动。  
｜通常境况下，每移动1格都需要消耗1点Mov。一些特殊的物景，例如崎岖的「地形」，会增加移动进入其中所需要消耗的Mov。  
